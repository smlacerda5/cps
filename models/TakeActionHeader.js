...
var TakeActionHeader = new keystone.List('TakeActionHeader', {
	map: { name: 'title' },
...
TakeActionHeader.add({
	...
	image : {
		...
		dest : 'public/images/take-action/',
		prefix : '/images/take-action/',
...
TakeActionHeader.schema.plugin(imageUrls, {path: '/images/take-action/'});

TakeActionHeader.register();
