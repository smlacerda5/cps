...
var EnquiryHeader = new keystone.List('EnquiryHeader', {
	map: { name: 'title' },
...
EnquiryHeader.add({
	...
	image : {
		...
		dest : 'public/images/enquiry/',
		prefix : '/images/enquiry/',
...
EnquiryHeader.schema.plugin(imageUrls, {path: '/images/enquiry/'});

EnquiryHeader.register();
